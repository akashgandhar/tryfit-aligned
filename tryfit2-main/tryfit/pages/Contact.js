...
export default function Contact(){
    ...
    return(
        <div className="">
            <Header />
            {/* Contact us section */}
            <div className="text-white pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40">
                <div className="flex flex-col mt-40 text-center bg-white/15 rounded-[23px] ">
                    <h1 className="font-aventa md:text-3xl lg:text-4xl xl:text-5xl pt-16">CONTACT US</h1>
                    <div>
                        <h1 className="flex justify-center mt-12 text-2xl md:text-5xl lg:text-6xl xl:text-7xl gap-3 font-heavitas">LETS DO <span className="text-btn_hover">AWESOME</span></h1>   
                        <h1 className="flex justify-center text-2xl md:text-5xl lg:text-6xl xl:text-7xl gap-3 font-heavitas pb-10">THINGS</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="text-white">
                <h1 className="md:ml-20 lg:ml-20 ml-8 xl:ml-40 mt-44 text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-aventa_bold">Get In Touch</h1>
            </div>
            ...
            <div className="text-white md:ml-20 lg:ml-20 xl:ml-40 grid xl:grid-cols-[1fr_1fr] lg:grid-cols-[1fr_1fr] ml-8 pr-8 lg:pr-20  md:pr-20 xl:pr-40 ">
                <div className=" xl:border-r-2 lg:border-r-2 border-white">
                    <h2 className=" mt-16 md:text-3xl lg:text-3xl xl:text-4xl text-btn_hover font-aventa">Send A Message</h2>
                    <p className=" mt-5 text-xl font-aventa">Just fill up this form and we will get right back to you </p>
                    ...
                    <form className=" mt-16 flex flex-col">
                        <div className="flex flex-col xl:pr-16 lg:pr-16">
                            ...
                            <input type="text" placeholder="Email" className="outline-none bg-black/0   input-placeholder2 input2 mt-16 " />
                        </div>
                        <div className="flex flex-col mt-16 xl:pr-16 lg:pr-16">
                            ...
                            <input type="text" placeholder="Phone No." className="outline-none bg-black/0 input-placeholder2 input2 mt-16 " />                               
                        </div>
                            <input type="text" placeholder="Message" className="outline-none bg-black/0 input-placeholder2 input2  mt-16 xl:mr-16 lg:mr-16" />                    
                    </form>
            ...
            <div className=" text-white mt-44 grid xl:grid-cols-[1fr_1fr]">
                <div className=" flex flex-col md:items-center lg:items-center xl:items-start  ml-8 md:ml-20 lg:ml-20 xl:ml-40 pr-8 lg:pr-20  md:pr-20 xl:pr-40">
                    ...
                    <h2 className=" mt-14 md:text-3xl lg:text-3xl xl:text-3xl font-aventa">For even further queries or doubts feel free to call us at</h2>
                ...
                <div className="ml-8 xl:ml-0 md:ml-20 lg:ml-20 pr-8 lg:pr-20 mt-10 xl:mt-0 md:pr-20 xl:pr-40">
                    <h2 className=" font-aventa_bold text-4xl">Why FAQs</h2>
                    <h2 className=" mt-4 text-2xl  font-aventa">These are some of the most frequent qeustion recieved do go through this, But we are always there for you</h2>
