    ...
    return(
        <div>
            ...
            <div className="flex  justify-center text-white text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl gap-4 font-heavitas mt-12">
                <h2>OUR <span className="text-btn_hover">TEAM</span></h2>
            </div>
            <div className="flex  justify-center text-white text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl gap-4 font-heavitas">
                <h2>OUR <span className="text-btn_hover">STRENGTH</span></h2>
            </div>
            <div className=" flex justify-center text-center mt-6 text-2xl  text-white">
                <p className=" font-aventa xl:max-w-5xl pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40">United by a common goal, our team leverages their unique strengths to create groundbreaking solutions. Get to know the minds shaping the future</p>
            </div>
            ...
            <div className="flex flex-col text-white font-heavitas mt-24 text-center">
                <h1 className=" text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl">Dive in Our</h1>
                <h1 className=" text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl text-btn_hover  ">World.</h1>
            </div>

            <section className="xl:hidden text-white grid place-items-start pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20">
                    <div className=" ">
                        {accordianData.map((data,index) => {
                            return <Accordian2 key={index} open={index === open } title={data.title} desc={data.desc} heading={data.heading} toggle={() => toggle(index)}/>
                        })}
                    </div>
            </section>
            ...
            <div className="hidden xl:grid xl:grid-cols-[1fr_1fr] text-white_yellow pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40 mt-8 sm:mt-28 gap-8 sm:gap-12">
                <div className=" bg-white/10 rounded-[25px]">
                    <div className=" mt-8 sm:mt-16 ml-4">
                        ...
                        <h2 className=" font-gilroy text-xl sm:text-3xl mt-8 sm:mt-11 p-4">{heading}</h2>
                        <p className=" font-ABeeZee mt-8 sm:mt-16 text-xl sm:text-2xl p-4">{desc}</p>     
                    </div>
                </div>
                <div className="grid grid-rows-[1fr_1fr_1fr]">
                    <div className="font-ABeeZee border border-white border-x-0">
                        <button className="flex flex-col" onClick={() => {setTitle('Who we are?'), setHeading('Legacy And Transition: From Bhatia Traders To Try Fit Fabrics'),setDescription('Formerly known as “Bhatia Traders” Try fit fabrics was founded in 1990 by Shri Kewal Kumar Bhatia. In due course of time, the company was handed over to his son Mr. Deepak Bhatia and the brand was renamed as “Try fit Fabrics”.')}} >
                            <h1 className=" font-ABeeZee text-btn_hover text-2xl sm:text-4xl mt-6">Who we are?</h1>
                            <p className=" text-left mt-4 sm:mt-5 pb-8 sm:pb-12">Formerly known as “Bhatia Traders” Try fit fabrics was founded in 1990 by Shri Kewal Kumar Bhatia. In due course of time, the company was handed over to his son Mr. Deepak Bhatia and the brand was renamed as “Try fit Fabrics”.</p>
                        </button>
                    </div>
                    <div>
                    <button className="flex flex-col no-underline" onClick={() => {setTitle('What we do?'), setHeading('Empowering Confidence Through Quality Fabrics'),setDescription('Try fit Fabrics, a premier fabric manufacturer, caters to diverse needs with quality textiles. Our customer-centric approach ensures satisfaction at every touchpoint. With four branches in India and expansion plans underway, accessibility is our priority. Renowned for our Sportswear fabrics, blending innovation and tradition, we empower global confidence.')}} >
                        <div className="font-ABeeZee border border-white border-x-0">
                            <h1 className="text-left font-ABeeZee text-btn_hover text-2xl sm:text-4xl mt-6">What we do?</h1>
                            <p className="text-left mt-4 sm:mt-5 pb-8 sm:pb-12">Try fit Fabrics is a fabric manufacturing brand that deals in all kinds of fabrics. We’re a customer-centric brand and always aim to make our customers happy.We’re renowned for distinctive new-age Sportswear fabrics. With a private manufacturing unit and warehouse in China.</p>
                        </div>
                    </button>
                    </div>
                    <div>
        ...
        <div className="flex ml-8  justify-center items-center mt-16 pr-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40 ">
            <div className="w-full  bg-white/15  rounded-[26px] flex flex-col items-center">
                <div className="flex gap-4">
                    <h1 className="font-aventa text-white text-3xl md:text-4xl lg:text-5xl xl:text-7xl mt-6 sm:mt-16">The</h1>
                    <h1 className="font-aventa text-btn_hover text-3xl md:text-4xl lg:text-5xl xl:text-7xl mt-6 sm:mt-16"> Great Minds</h1>
                </div>
                <div className="flex gap-4">
                    <h1 className="font-aventa text-white text-3xl md:text-4xl lg:text-5xl xl:text-7xl  ">Behind</h1>
                    <h1 className="font-aventa text-btn_hover text-3xl md:text-4xl lg:text-5xl xl:text-7xl  "> Our Success</h1>
                </div>
