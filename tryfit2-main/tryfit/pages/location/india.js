...
export default function India() {
  ...
  return (
    <div>
      <Header />
      <div className="pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40 mt-[150px]">
        <img src="/images/ourlocation.png" className="w-full " />
      </div>
      <section className="flex px-10 md:px-20 lg:px-20 xl:px-40 gap-2 flex-col-reverse xl:flex-row">
