        ...
        <div className="mt-11 xl:grid-cols-[2fr_0.8fr] pr-8 grid  gap-4  lg:pr-20 xl:pr-40 md:pr-20">
            <div>
                <span className="flex flex-col w-full xl:h-[400px]  lg:h-[484px] md:h-[484px] bg-white border rounded-[25px]">
                    ...
                    <button className="flex text-dive_color border border-dive_color w-[140px] md:w-[240px] lg:w-[240px] xl:w-[240px] text-center justify-center py-1 lg:text-4xl md:text-3xl sm:text-xl rounded-[13px] font-aventa ml-12 mt-4 xl:mt-4">Our Story</button>
                    <p className="text-dive_color max-w-3xl ml-10 mt-7 font-aventa_bold font-medium sm:text-xl md:text-2xl lg:text-2xl xl:text-xl pb-4">"Try fit Fabrics, formerly Bhatia Traders, has been a trusted name in fabrics since 1990. Under Mr. Deepak Bhatia's leadership, we're customer-centric, quality-driven, and poised for nationwide expansion."</p>
                    </span>
                </div>
            <div>
                ...
                <button className="flex h-[45px] px-20 items-center btn_green mt-[300px]  rounded-[10px]  ">
