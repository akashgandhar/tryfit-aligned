    ...
    <div className="mt-11 xl:grid-cols-[2fr_0.8fr] pr-8 grid  gap-4  lg:pr-20 xl:pr-40 md:pr-20">
      ...
      >
        <span className="flex flex-col w-full xl:h-[400px]  lg:h-[484px] md:h-[484px] bg-white border rounded-[25px]">
            ...
            <div className="flex flex-col">
              ...
              <h2 className=" flex text-dive_color md:text-4xl text-3xl lg:text-6xl xl:text-6xl font-heavitas ml-10 gap-4">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className=" w-8 h-8 xl:w-20 xl:h-20 lg:w-14 lg:h-14 md:w-12 md:h-12  rotate-45 "
                >
                  <path
                    fillRule="evenodd"
          ...
          <button className="flex text-dive_color border border-dive_color w-[140px] md:w-[240px] lg:w-[240px] xl:w-[240px] text-center justify-center py-1 lg:text-4xl md:text-3xl sm:text-xl rounded-[13px] font-aventa ml-12 mt-4 xl:mt-4">
            Our Story
          </button>
          <p className="text-dive_color max-w-3xl ml-10 mt-7 font-aventa_bold font-medium sm:text-xl md:text-2xl lg:text-2xl xl:text-xl pb-4">
