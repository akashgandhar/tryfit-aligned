      ...
      >
        <SwiperSlide>
          <div className=" flex flex-col font-aventa items-center bg-white/15 rounded-2xl backdrop-blur-sm">
            <img src="/images/m1.jpg" className="object-cover" />
            <h2 className="text-white md:text-2xl lg:text-3xl xl:text-4xl mt-6">
              Mr Grish
            </h2>
        ...
        <SwiperSlide>
          <div className=" flex flex-col font-aventa items-center bg-white/15 rounded-2xl backdrop-blur-sm">
            <img src="/images/m2.jpg" className="object-cover aspect-square" />
            <h2 className="text-white md:text-2xl lg:text-3xl xl:text-4xl mt-6">
              Mr Grish
            </h2>
            <h2 className="text-btn_hover xl:text-2xl pb-6">Branch Manager</h2>
        ...
        <SwiperSlide>
          <div className=" flex flex-col font-aventa items-center bg-white/15 rounded-2xl backdrop-blur-sm">
            <img src="/images/m3.jpg" className="object-cover aspect-square" />
            <h2 className="text-white md:text-2xl lg:text-3xl xl:text-4xl mt-6">
              Mr Grish
            </h2>
            <h2 className="text-btn_hover xl:text-2xl pb-6">Branch Manager</h2>
        ...
        <SwiperSlide>
          <div className=" flex flex-col font-aventa items-center bg-white/15 rounded-2xl backdrop-blur-sm">
            <img src="/images/m4.png" className="object-cover aspect-square" />
            <h2 className="text-white md:text-2xl lg:text-3xl xl:text-4xl mt-6">
              Mr Grish
            </h2>
            <h2 className="text-btn_hover xl:text-2xl pb-6">Branch Manager</h2>
        ...
        <SwiperSlide>
          <div className=" flex flex-col font-aventa items-center bg-white/15 rounded-2xl backdrop-blur-sm">
            <img src="/images/m5.jpg" className="object-cover aspect-square" />
            <h2 className="text-white md:text-2xl lg:text-3xl xl:text-4xl mt-6">
              Mr Grish
            </h2>
            <h2 className="text-btn_hover xl:text-2xl pb-6">Branch Manager</h2>
