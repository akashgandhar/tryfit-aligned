...
export default function Footer() {
  return (
    <footer className="text-white w-full h-auto bg-black_shade/10 pr-8 pl-8  lg:pr-20  md:pr-20 md:pl-20 lg:pl-20 xl:pl-40 xl:pr-40 mt-28">
      <div className="flex items-center font-ABeeZee">
        <img src="/images/logo.png" className="  pt-16 w-28"></img>
        <h1 className=" text-3xl ml-2 mt-8">TRYFIT FABRICS</h1>
      </div>
      <div className="xl:grid lg:grid md:hidden hidden xl:grid-cols-[1fr_2fr_0.4fr] ">
        <div className="xl:flex md:flex md:justify-center xl:flex-col font-ABeeZee">
          <div>
            <h2 className="res  underline mt-5">Contact Us</h2>
            <h2 className=" mt-9 inline-flex gap-2 max-w-xs res">
              <svg
                width="80"
                height="34"
                viewBox="0 0 24 34"
          ...
          <div className="md:flex xl:ml-0 xl:mt-0 md:mt-10 md:ml-[100px] md:flex-col">
            <h2 className="inline-flex mt-9 gap-2 res items-center">
              ...
              >
                <path
                  d="M30.4009 0.010534C30.2646 -0.00351133 30.1272 -0.00351133 29.9909 0.010534H1.99094C1.81148 0.0132991 1.63321 0.0402073 1.46094 0.0905339L15.9109 14.4805L30.4009 0.010534Z"
                  fill="#F6F6F6"
                />
                <path
                  d="M31.88 1.40234L17.32 15.9023C16.9453 16.2748 16.4384 16.4839 15.91 16.4839C15.3816 16.4839 14.8747 16.2748 14.5 15.9023L0.0700001 1.51234C0.0256394 1.67538 0.00211869 1.84339 0 2.01234V22.0123C0 22.5428 0.210714 23.0515 0.585786 23.4266C0.960859 23.8016 1.46957 24.0123 2 24.0123H30C30.5304 24.0123 31.0391 23.8016 31.4142 23.4266C31.7893 23.0515 32 22.5428 32 22.0123V2.01234C31.992 1.804 31.9516 1.59818 31.88 1.40234ZM3.37 22.0123H1.98V20.5823L9.25 13.3723L10.66 14.7823L3.37 22.0123ZM29.98 22.0123H28.58L21.29 14.7823L22.7 13.3723L29.97 20.5823L29.98 22.0123Z"
                  fill="#F6F6F6"
                />
              </svg>
              info@tryfitfabrics.com
            </h2>
            <div className="flex flex-row mt-9 gap-2 res">
              <svg
                width="28"
                height="28"
                viewBox="0 0 28 28"
              ...
              >
                <path
                  d="M26.3667 28C23.1259 28 19.9241 27.2938 16.7611 25.8813C13.5981 24.4689 10.7204 22.4659 8.12778 19.8722C5.53519 17.2796 3.53267 14.4019 2.12022 11.2389C0.707778 8.07593 0.00103704 4.87407 0 1.63333C0 1.16667 0.155555 0.777778 0.466667 0.466667C0.777778 0.155555 1.16667 0 1.63333 0H7.93333C8.2963 0 8.62037 0.123407 8.90556 0.370222C9.19074 0.617037 9.35926 0.908444 9.41111 1.24444L10.4222 6.68889C10.4741 7.1037 10.4611 7.4537 10.3833 7.73889C10.3056 8.02407 10.163 8.27037 9.95555 8.47778L6.18333 12.2889C6.70185 13.2481 7.31733 14.1747 8.02978 15.0687C8.74222 15.9626 9.52674 16.8249 10.3833 17.6556C11.187 18.4593 12.0296 19.2049 12.9111 19.8924C13.7926 20.58 14.7259 21.2084 15.7111 21.7778L19.3667 18.1222C19.6 17.8889 19.9049 17.7141 20.2813 17.598C20.6578 17.4819 21.027 17.4492 21.3889 17.5L26.7556 18.5889C27.1185 18.6926 27.4167 18.8808 27.65 19.1536C27.8833 19.4263 28 19.7307 28 20.0667V26.3667C28 26.8333 27.8444 27.2222 27.5333 27.5333C27.2222 27.8444 26.8333 28 26.3667 28Z"
                  fill="#F6F6F6"
                />
              </svg>
              <h2>
                <p>
                  <span className="text-[#86FF73]">INDIA :</span> +91 9899505468
                </p>
                <p>
                  <span className="text-[#86FF73]">CHINA :</span> +86
                  13357565474
                </p>
              </h2>
            </div>
        ...
        <div className="flex gap-8 justify-between items-start">
          <div className="font-ABeeZee justify-center xl:mr-2 lg:pl-32">
            <h2 className="res  underline  justify-center ">Location</h2>
            <h2 className=" mt-7 res">India</h2>
            <h2 className=" res mt-4">China</h2>
          </div>
          <div className="font-ABeeZee xl:pr-2 lg:pr-32">
            <Link href={"/Blog"} className="res  underline mt-5 ">
              Company
            </Link>
            <h2 className=" mt-7 res">About Us</h2>
            <h2 className=" mt-4 res">Catalogue</h2>
            <h2 className=" mt-4 res">Teams</h2>
            <h2 className=" mt-4 res">Contacts Us</h2>
          </div>
        </div>
      </div>
      <div className=" xl:border lg:border xl:border-x-0 pb-8  xl:border-b-2 lg:border-b-2 mt-14">
        <div className="xl:grid lg:grid md:hidden hidden xl:grid-cols-[1fr_1.5fr_0.7fr] md:gap-8 mt-12 justify-center items-center">
          <div className="flex gap-12 justify-center">
            <Link
              target="_blank"
              href="https://youtube.com/@tryfitfabrics2595?si=gz4FjMIj1IeEyWsP"
            >
              <svg
            ...
            <Link href="https://www.instagram.com/tryfitfabrics/">
              ...
              >
                <path
                  d="M33.5 2H12.5C6.70101 2 2 6.70101 2 12.5V33.5C2 39.299 6.70101 44 12.5 44H33.5C39.299 44 44 39.299 44 33.5V12.5C44 6.70101 39.299 2 33.5 2Z"
                  stroke="white"
                  stroke-width="4"
            ...
            <Link
              target="_blank"
              href="https://api.whatsapp.com/send?phone=8618094752795"
            >
              <svg
                className="hover:scale-105 transition-all ease-in-out duration-300"
                width="40"
          ...
          <div className="flex justify-center text-center xl:mt-0 lg:mt-0 md:mt-4 mt-4 items-center ">
            <h2 className=" res font-abessinica xl:w-[750px] text-center">
              Subscribe to our news letter stay tuned for new web <br />
              design and latest updates. Let&apos;s do it!
            </h2>
          </div>
        ...
        <div className=" p-4 justify-center items-center mt-5 xl:flex lg:flex md:hidden hidden">
          <span className="text-white xl:text-3xl font-aventa font-semibold mr-6">
            Newsletter
          </span>
          <div className="bg-white p-1">
            <input
              ...
              className="text-black mx-4 px-2 py-1 xl:w-[400px] outline-none"
            />
      ...
      <div className="xl:hidden lg:hidden md:flex flex flex-col">
        <h2 className="text-2xl font-aventa_bold underline">Contact Us</h2>
        <h2 className=" mt-5 inline-flex gap-2 max-w-xs font-aventa res">
          <svg
            width="80"
            height="34"
            viewBox="0 0 24 34"
          ...
          Building No. 6012, Bhatia Building, Subhash Mohalla, Raghubar Pura,
          Lal Batti Chowk, Gandhi Nagar, Delhi 110031 (India)
        </h2>
        <h2 className="inline-flex mt-10 font-aventa gap-2 res items-center">
          <svg
            width="32"
            height="25"
            viewBox="0 0 32 25"
        ...
        <div className="flex flex-row mt-10 font-aventa gap-2 res mb-5">
          <svg
            width="28"
            height="28"
            viewBox="0 0 28 28"
          ...
          <h2>
            ...
            <p>
              <span className="text-[#86FF73]">CHINA :</span> +86 13357565474
            </p>
          </h2>
        </div>
      </div>
      <div className="xl:hidden lg:hidden md:grid grid grid-cols-2 border border-x-0 pb-5 pt-5">
        <div className="">
          <h2 className="text-xl font-aventa_bold underline">COMPANY</h2>
          <h3 className="font-aventa">About Us</h3>
          <h3 className="font-aventa">Catalogue</h3>
          <h3 className="font-aventa">Blogs</h3>
          <h3 className="font-aventa">Contact Us</h3>
        </div>
        <div>
          <h2 className="text-xl font-aventa_bold underline">REACH US AT</h2>
          <h3 className="font-aventa flex items-center gap-2">
            Intagram <BsArrowUpRight />
          </h3>
          <h3 className="font-aventa flex items-center gap-2">
            Youtube <BsArrowUpRight />
          </h3>
          <h3 className="font-aventa flex items-center gap-2">
            Facebook <BsArrowUpRight />
          </h3>
        </div>
      </div>
      <div>
      ...
      <div className="flex justify-center text-center mt-4 gap-2">
        <h1 className="text-white font-aventa text-sm ">
          Designed & Managed By
        </h1>
        <Link href="https://www.bitstobug.com/" className=" font-Rogue pb-4">
          Bits To Bug
        </Link>
      </div>
    </footer>
