  ...
  useEffect(() => {
    ...
    return (
      <div  className="flex flex-col justify-center items-center mt-8 pr-8 ml-8 lg:pr-20  md:pr-20 md:ml-20 lg:ml-20 xl:ml-40 xl:pr-40">
        <div className="flex w-full  bg-faq_background rounded-t-[26px] items-start justify-center pt-16">
          <div className="flex flex-col items-center"> 
            <button className="btn_green inline-flex items-center text-xs btn_shadow py-0.5 px-2 xl:py-0.5 xl:px-16 md:py-0.5 md:px-24 lg:py-0.5 lg:px-16 gap-3 xl:rounded-[15px] lg:rounded-[15px] md:rounded-[15px] rounded-lg">
              <svg className="w-8 h-8 hidden md:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <h1 className="font-heavitas text-white text-xl md:text-4xl lg:text-5xl xl:text-6xl mt-11">EMPOWERING</h1>
            <div className="xl:inline-flex lg:flex md:flex text-center gap-3">
                <h1 className="font-heavitas text-btn_hover text-xl md:text-4xl lg:text-5xl xl:text-6xl">SUCCESS</h1>
                <h1 className="font-heavitas text-white text-xl md:text-4xl lg:text-5xl xl:text-6xl ">IN NUMBERS</h1>
            </div>
        ...
        <div ref={ref}   className="flex w-full py-10  bg-faq_background2 rounded-b-[26px] justify-center items-center">
            <div  className="text-white font-aventa_bold grid xl:grid-cols-[1fr_1fr_1fr] lg:grid-cols-[1fr_1fr_1fr] md:grid-cols-[1fr_1fr_1fr] gap-4 xl:gap-[140px] lg:gap-[50px]">
              <div  className="text-center">
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl ">{count}%</h1>
                <p className=" md:text-lg lg:text-xl xl:text-2xl">Satisfactory Rate</p>
              </div>
              <div className="text-center">
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl ">{count2}+</h1>
                <p className="md:text-lg lg:text-xl xl:text-2xl">Delivered Projects</p>
              </div>
              <div className="text-center">
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl">{count3}+</h1>
